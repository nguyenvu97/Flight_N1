...
import org.tasc.booking.apiclient.dto.*;
import org.tasc.booking.apiclient.email.EmailDto;
//import org.tasc.booking.apiclient.kafka.KafkaService;
import org.tasc.booking.apiclient.ticket.TicketApi;
import org.tasc.booking.vnpay_Service.email.EmailSender;
import org.springframework.data.mongodb.core.MongoTemplate;
import org.springframework.http.HttpStatus;
import org.springframework.http.ResponseEntity;
import org.springframework.web.bind.annotation.*;
import org.tasc.booking.vnpay_Service.kafka.KafkaService;
//import org.tasc.booking.vnpay_Service.kafka.KafkaService;
...
import static org.tasc.booking.vnpay_Service.vnpay.Config.*;
...
* */
    ...
    @GetMapping
    public ResponseEntity<?> hashUrl(@RequestParam(value = "orderNo") String orderNo,@RequestParam boolean choose) {
        /*
        choose = true thi la web
        nguoi lai thi la app
        * */
        var listTicket = ticketApi.get(orderNo);
        long money = 0;

            money += (long) listTicket.getTotalTicket();
        String url = choose? vnp_Returnurl : vnp_Returnurl_Flutter;
...
//            kafkaService.send_ticket(tickets);
                return new RedirectView("http://localhost:5278/");
        }
        String body = "<!DOCTYPE html>\n" + "<html>\n" + "<head>\n" + "    <title>Thanh Toán Thất bại </title>\n" + "    <style>\n" + "        body {\n" + "            font-family: Arial, sans-serif;\n" + "            text-align: center;\n" + "        }\n" + "        h1 {\n" + "            color: #008000;\n" + "        }\n" + "    </style>\n" + "</head>\n" + "<body>\n" + "    <h1>Thanh Toán Thất bại</h1>\n"   + "</body>\n" + "</html>\n";
        return body;
    }
    @GetMapping("/domain1.vn")
